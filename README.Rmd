...
> the pipeline itself are their work; this repository only packages the
> dependencies into a single Apptainer/Singularity image so the pipeline runs
> without building conda environments at run time.
>
